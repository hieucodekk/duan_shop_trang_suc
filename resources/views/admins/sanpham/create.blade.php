            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form method="POST" action="{{ route('admins.sanphams.store') }}" 
                                ...
                                <div class="row">
                                    <div class="col-lg-4 mb-4">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select name="danh_muc_id" class="form-select">
                                                <option value="" selected>--Chon danh muc--</option>
                                                @foreach ($danhMuc as $item)
                                                    <option value="{{ $item->id }}"
                                                        {{ old('ten') == $item->id ? 'selected' : '' }}>
                                    ...
                                    <div class="col-lg-8 ">
                                        <div class="mb-3">
                                            <label for="hinh_anh" class="form-label ">Mo ta chi tiet</label>
