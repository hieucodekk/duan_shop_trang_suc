                            ...
                            <div class="product-tab-menu">
                                <ul class="nav justify-content-center">
                                    @foreach ($listDanhMuc as $item)
                                        <li><a href="{{route('spdanhmuc',$item->id)}}" class="active">{{$item->ten_danh_muc}}</a></li> 
                                    @endforeach
                                           ...
                                           <div class="product-item">
                                            <figure class="product-thumb">
                                                <a href="{{route('products.detail', $sanPham->id)}}">
                                                    <img class="pri-img" src="{{Storage::url($sanPham->hinh_anh)}}" alt="product">
                                                    <img class="sec-img" src="{{Storage::url($sanPham->hinh_anh)}}" alt="product">
                                                </a>
                                            ...
                                            <div class="product-caption text-center">
                                                ...
                                                href="{{route('products.detail', $sanPham->id)}}">{{ $sanPham->danhMuc->ten_danh_muc }}</a></p>
                                                <h6 class="product-name">
                                                    <a href="{{route('products.detail', $sanPham->id)}}">{{$sanPham->ten_san_pham}}</a>
                                                </h6>
                                                <div class="price-box">
